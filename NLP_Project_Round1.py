...
Original file is located at
    https://colab.research.google.com/drive/1gqga3JeRfkg0VTLd5-0L8XGtH_fJxTit
"""

from google.colab import drive
drive.mount('/content/drive')

f= open('/content/drive/My Drive/nlp project/Pride and Prejudice.txt', 'r')
text1=f.read()
k= open('/content/drive/My Drive/nlp project/A tale of two cities.txt', 'r')
text2=k.read()
...
print('Total Number of Words in Book 1 :', len(twords))
twords2 = text2.split()

print('Total Number of words in Book 2 :', len(twords2))



number_of_characters = len(text1)
print('Total Number of Characters in Book 1 (with spaces) :', number_of_characters)

number_of_characters = len(text2)
print('Total Number of Characters in Book 2 (with spaces) :', number_of_characters)

data = text1.replace(" ","")
#get the length of the data
number_of_characters = len(data)
print('Total Number of Characters in Book 1 (without spaces) :', number_of_characters)
data = text2.replace(" ","")
number_of_characters = len(data)
print('Total Number of Characters in Book 2 (without spaces) :', number_of_characters)




num_lines = 0
with open('/content/drive/My Drive/nlp project/Pride and Prejudice.txt', 'r') as f:
    for line in f:
        num_lines += 1
print("Total Number of Lines in Book 1:")
print(num_lines)



num_lines = 0
with open('/content/drive/My Drive/nlp project/A tale of two cities.txt' ,'r') as f:
    for line in f:
        num_lines += 1
print("Total Number of Lines in Book 2:")
print(num_lines)
